...
public class OAuth2ServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients)
        ...
        clients.withClientDetails(clientId -> {
            ...
            String clientIdMock = "clientIdMock";
            String clientSecretMock = "clientSecretMock";
            Collection<String> scopeMock = Collections.singleton("auth");
            Collection<String> grantTypesMock = Arrays.asList("authorization_code", "refresh_token");
    ...
    public JwtAccessTokenConverter accessTokenConverter() {
        ...
        UserAuthenticationConverter authenticationConverter = new DefaultUserAuthenticationConverter();
